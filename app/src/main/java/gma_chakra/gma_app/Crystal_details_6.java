 ...
 */
public class Crystal_details_6 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chakra_info_6);
        id=getIntent().getIntExtra("Position", 0);
        sharedpreference=getSharedPreferences(MyPreference, Context.MODE_PRIVATE);
        seekbar=(SeekBar)findViewById(R.id.ck6_seekbar);
        img=(ImageView)findViewById(R.id.imageView_ck6);
      ...
      //  Toast.makeText(getApplicationContext(), "Sound " + sound_on_off, Toast.LENGTH_LONG).show();
        ...
        back=(Button)findViewById(R.id.back_button6);
        next=(Button)findViewById(R.id.nextbutton6);
        mainmeu=(Button)findViewById(R.id.main_menubutton6);

//        l1=(LinearLayout)findViewById(R.id.ck6_first);
//        l2=(LinearLayout)findViewById(R.id.ck6_second);
//        l3=(LinearLayout)findViewById(R.id.ck6_text);
//
...
//        l3.setLayoutParams(parms3);
        ...
        if(sound_on_off==1) {
            mediaPlayer = MediaPlayer.create(this, R.raw.chakra7);
                 ...
                 cntr_aCounter = new CountDownTimer(t,1000) {
                    ...
                    public void onFinish() {
                        ...
                        if(id==10 || id==1)
                        {
                            ...
                            Intent i = new Intent(Crystal_details_6.this,Crystal_details_7.class );
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.nextbutton6:
                ...
                intent=new Intent(Crystal_details_6.this,Crystal_details_7.class);
            ...
            case R.id.back_button6:
                ...
                intent=new Intent(Crystal_details_6.this,Crystal_details_5.class);
                startActivity(intent);
               // finish();
                break;
            case R.id.main_menubutton6:
                if(sound_on_off==1) {
                    if (mediaPlayer.isPlaying()) {
                        mediaPlayer.stop();
                    }
                }
                intent=new Intent(Crystal_details_6.this,MainMenuClass.class);
                startActivity(intent);
                finish();
                break;
        }
    ...
    public void showCrystal()
    {
        ...
        bigImage.setBackgroundResource(R.drawable.chakracrystal6);
