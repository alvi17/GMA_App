 ...
 */
public class Crystal_details_7 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chakra_info_7);
        id=getIntent().getIntExtra("Position", 0);
        sharedpreference=getSharedPreferences(MyPreference, Context.MODE_PRIVATE);
        seekbar=(SeekBar)findViewById(R.id.ck7_seekbar);
        img=(ImageView)findViewById(R.id.imageView_ck7);
    ...
    //    Toast.makeText(getApplicationContext(), "Sound " + sound_on_off, Toast.LENGTH_LONG).show();
        ...
        back=(Button)findViewById(R.id.back_button7);
        next=(Button)findViewById(R.id.nextbutton7);
        mainmeu=(Button)findViewById(R.id.main_menubutton7);

//        l1=(LinearLayout)findViewById(R.id.ck7_first);
//        l2=(LinearLayout)findViewById(R.id.ck7_second);
//        l3=(LinearLayout)findViewById(R.id.ck7_text);
//
...
//        l3.setLayoutParams(parms3);
        ...
        if(sound_on_off==1) {
            mediaPlayer = MediaPlayer.create(this, R.raw.new_chakra);
                ...
                cntr_aCounter = new CountDownTimer(t,1000) {
                    ...
                    public void onFinish() {
                        ...
                        if(id==10 || id==1)
                        {
                            ...
                            Intent i = new Intent(Crystal_details_7.this,Crystal_details_8.class );
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.nextbutton7:
                ...
                intent=new Intent(Crystal_details_7.this,Crystal_details_8.class);
            ...
            case R.id.back_button7:
                ...
                intent=new Intent(Crystal_details_7.this,Crystal_details_6.class);
                startActivity(intent);
               // finish();
                break;
            case R.id.main_menubutton7:
                if(sound_on_off==1) {
                    if (mediaPlayer.isPlaying()) {
                        mediaPlayer.stop();
                    }
                }
                intent=new Intent(Crystal_details_7.this,MainMenuClass.class);
                startActivity(intent);
                finish();
                break;
    ...
    public void showCrystal()
    {
        ...
        bigImage.setBackgroundResource(R.drawable.chakracrystal7);
