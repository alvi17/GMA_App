 ...
 */
public class Crystal_details_8 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chakra_info_8);
        id=getIntent().getIntExtra("Position", 0);
        sharedpreference=getSharedPreferences(MyPreference, Context.MODE_PRIVATE);
        seekbar=(SeekBar)findViewById(R.id.ck8_seekbar);
        img=(ImageView)findViewById(R.id.imageView_ck8);
    ...
    //    Toast.makeText(getApplicationContext(), "Sound " + sound_on_off, Toast.LENGTH_LONG).show();
        ...
        back=(Button)findViewById(R.id.back_button8);
        next=(Button)findViewById(R.id.nextbutton8);
        mainmeu=(Button)findViewById(R.id.main_menubutton8);



//        l1=(LinearLayout)findViewById(R.id.ck8_first);
//        l2=(LinearLayout)findViewById(R.id.ck8_second);
//        l3=(LinearLayout)findViewById(R.id.ck8_text);
//
...
//        l3.setLayoutParams(parms3);
        ...
        if(sound_on_off==1) {
            mediaPlayer = MediaPlayer.create(this, R.raw.chakra8);
                ...
                else
                {
                    ...
                    public void onFinish() {
                        ...
                        if(id==10)
                        {
                            ...
                            Intent i = new Intent(Crystal_details_8.this,Crystal_Details.class );
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.main_menubutton8:
                ...
                intent=new Intent(Crystal_details_8.this,MainMenuClass.class);
                startActivity(intent);
                finish();
                break;
    ...
    public void showCrystal()
    {
        ...
        bigImage.setBackgroundResource(R.drawable.chakracrystal8);
