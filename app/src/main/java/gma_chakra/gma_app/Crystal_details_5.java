 ...
 */
public class Crystal_details_5 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chakra_info_5);
        id=getIntent().getIntExtra("Position", 0);
        sharedpreference=getSharedPreferences(MyPreference, Context.MODE_PRIVATE);
        seekbar=(SeekBar)findViewById(R.id.ck5_seekbar);
        img=(ImageView)findViewById(R.id.imageView_ck5);
...
//        l1=(LinearLayout)findViewById(R.id.ck5_first);
//        l2=(LinearLayout)findViewById(R.id.ck5_second);
//        l3=(LinearLayout)findViewById(R.id.ck5_text);
//
...
//        l3.setLayoutParams(parms3);
        ...
        next=(Button)findViewById(R.id.nextbutton5);
        mainmeu=(Button)findViewById(R.id.main_menubutton5);
                 ...
                 cntr_aCounter = new CountDownTimer(t,1000) {
                    ...
                    public void onFinish() {
                        ...
                        if(id==10 || id==1)
                        {
                            ...
                            Intent i = new Intent(Crystal_details_5.this,Crystal_details_6.class );
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.nextbutton5:
                ...
                intent=new Intent(Crystal_details_5.this,Crystal_details_6.class);
            ...
            case R.id.back_button5:
                ...
                intent=new Intent(Crystal_details_5.this,Crystal_details_4.class);
                startActivity(intent);
                finish();
                break;
            case R.id.main_menubutton5:
                if(sound_on_off==1) {
                    if (mediaPlayer.isPlaying()) {
                        mediaPlayer.stop();
                    }
                }
                intent=new Intent(Crystal_details_5.this,MainMenuClass.class);
                startActivity(intent);
                finish();
                break;
    ...
    public void showCrystal()
    {
        ...
        bigImage.setBackgroundResource(R.drawable.chakracrystal5);
