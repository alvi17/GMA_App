 ...
 */
public class Light_Body_Meditation extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.light_body_meditation);

        LinearLayout l1=(LinearLayout)findViewById(R.id.light_ll);
       ...
       // l1.setLayoutParams(parms);
        ...
        mediaPlayer=MediaPlayer.create(this,R.raw.light_body_medi);
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
        mediaPlayer.setVolume(1, 1);
        mediaPlayer.start();
        finalTime = mediaPlayer.getDuration();
        startTime = mediaPlayer.getCurrentPosition();
        mainMenu=(Button)findViewById(R.id.light_body_mainbutton4);
        mainMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(Light_Body_Meditation.this,MainMenuClass.class);
                startActivity(intent);
                finish();
            }
        });
        pauseButton=(ImageButton)findViewById(R.id.pause_imageButton_light);
...
//            );
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i=new Intent(Light_Body_Meditation.this,MainMenuClass.class);
        startActivity(i);
        finish();
    }
}
