 ...
 */
public class Crystal_details_2 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chakra_info_2);

        seekbar=(SeekBar)findViewById(R.id.ck2_seekbar);
        img=(ImageView)findViewById(R.id.imageView_ck2);
      ...
      //  fm=(FrameLayout)findViewById(R.id.chakra_2_frame);
//        l1=(LinearLayout)findViewById(R.id.ck2_first);
//        l2=(LinearLayout)findViewById(R.id.ck2_second);
//        l3=(LinearLayout)findViewById(R.id.ck2_text);
//
...
//        l3.setLayoutParams(parms3);
        ...
        mainmeu=(Button)findViewById(R.id.main_menubutton2);
                ...
                cntr_aCounter = new CountDownTimer(t,1000) {
                    ...
                    public void onFinish() {
                        ...
                        if(id==10 || id==1)
                        {
                            ...
                            Intent i = new Intent(Crystal_details_2.this,Crystal_details_3.class );
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.main_menubutton2:
                ...
                intent=new Intent(Crystal_details_2.this,MainMenuClass.class);
                startActivity(intent);
                finish();
                break;
    ...
    public void showCrystal()
    {
        ...
        bigImage.setBackgroundResource(R.drawable.chakracrystal2);
