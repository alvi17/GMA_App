 ...
 */
public class Crystal_details_3 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chakra_info_3);
        id=getIntent().getIntExtra("Position", 0);
        sharedpreference=getSharedPreferences(MyPreference, Context.MODE_PRIVATE);
        seekbar=(SeekBar)findViewById(R.id.ck3_seekbar);
        img=(ImageView)findViewById(R.id.imageView_ck3);
  ...
  //      Toast.makeText(getApplicationContext(), "Sound " + sound_on_off, Toast.LENGTH_LONG).show();
        ...
        mainmeu=(Button)findViewById(R.id.main_menubutton3);

//        l1=(LinearLayout)findViewById(R.id.ck3_first);
//        l2=(LinearLayout)findViewById(R.id.ck3_second);
//        l3=(LinearLayout)findViewById(R.id.ck3_text);
//
...
//        l3.setLayoutParams(parms3);
        ...
        if(sound_on_off==1) {
            mediaPlayer = MediaPlayer.create(this, R.raw.chakra2);
                 ...
                 cntr_aCounter = new CountDownTimer(t,1000) {
                    ...
                    public void onFinish() {
                        ...
                        if(id==10 || id==1)
                        {
                            ...
                            Intent i = new Intent(Crystal_details_3.this,Crystal_details_4.class );
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.nextbutton3:
                ...
                intent=new Intent(Crystal_details_3.this,Crystal_details_4.class);
            ...
            case R.id.back_button3:
                ...
                intent=new Intent(Crystal_details_3.this,Crystal_details_2.class);
                startActivity(intent);
               // finish();
                break;
            case R.id.main_menubutton3:
                if(sound_on_off==1) {
                    if (mediaPlayer.isPlaying()) {
                        mediaPlayer.stop();
                    }
                }
                intent=new Intent(Crystal_details_3.this,MainMenuClass.class);
                startActivity(intent);
                finish();
                break;
    ...
    public void showCrystal()
    {
        ...
        bigImage.setBackgroundResource(R.drawable.chakracrystal3);
